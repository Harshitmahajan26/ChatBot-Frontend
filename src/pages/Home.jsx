    ...
    <div className="flex h-screen bg-gray-900 text-white">
      ...
      {chats && chats.length === 0 ? (
        ...
        <div className="fixed bottom-0 right-0 left-auto p-4 bg-gray-900 w-full md:w-[75%]">
          ...
          >
            <input className="flex-grow p-4 bg-gray-700 rounded-l text-white outline-none" type="text" placeholder="Enter a promp here" value={prompt} onChange={(e) => setPrompt(e.target.value)} required />
